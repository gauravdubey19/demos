    ...
    <div className="m-8 h-[90vh] pb-8">
      ...
      <div className="text-center mb-8 px-24">
        ...
        <p className="text-gray-600 mb-6">
          ...
          common questions, track your orders, manage returns, and more.
        </p>
      </div>
        ...
        <div className="bg-yellow-100 p-4 rounded-md w-60">
          <Link href="/contact" passHref>
            <div className="text-center cursor-pointer">
              <p className="text-lg font-semibold">FAQs & Queries</p>
      ...
      {/* Submit Ticket Form */}
      <div className="mt-8 flex justify-center px-4 sm:px-6 lg:px-2 pb-8">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
              ...
              <input
                ...
                className="w-full p-3 border rounded-md bg-gray-100 focus:outline-none focus:ring-2 focus:ring-yellow-400"
                required
              />
            </div>
            ...
            <div className="mb-6">
              ...
              <textarea
                ...
                onChange={handleInputChange}
                className="w-full p-3 border rounded-md bg-gray-100 focus:outline-none focus:ring-2 focus:ring-yellow-400 resize-y"
                required
              ></textarea>
            </div>
            ...
            <div className="flex justify-center">
              <button
                type="submit"
                className="w-1/3 p-3 bg-yellow-400 text-white font-bold rounded-md hover:bg-yellow-500 transition-colors disabled:opacity-70"
                disabled={sending}
              >
