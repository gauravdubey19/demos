...
//         <div className="w-full h-fit flex-between  md:py-6">
...
//         </div>
//         {/* left */}
//         <div className="w-full flex flex-row gap-3 pt-10">
//           <div className="bg-white p-6 rounded-lg border border-[#d8d8d8] w-[60%]">
...
//               </div>
//             </div>
//             {/* <div className="px-2 bg-[#d8d8d8] w-full h-[2px]"/> */}
...
//           </div>
//           {/* right */}
//           <div className="w-[40%] flex flex-col gap-4 sticky top-20">
