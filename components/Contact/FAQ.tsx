...
const FAQ = () => {
  ...
  return (
    <div
      id="faqs"
      className="bg-[#fff9ef] px-2 py-20 sm:px-4 md:px-8 lg:px-20 md:py-32 lg:py-32 min-h-screen"
    >
      <h1 className="font-semibold text-xl sm:text-3xl mb-6 md:mb-8 ">
