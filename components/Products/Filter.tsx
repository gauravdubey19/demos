...
const Filter: React.FC = () => {
  ...
  return (
    <Drawer>
      ...
      {/* Drawer Content */}
      <DrawerContent className="bottom-0 z-50 w-full h-fit max-h-[80vh] md:max-h-[50vh] rounded-t-3xl text-white backdrop-blur-[5px] bg-white/20 border-none outline-none shadow-lg p-4 overflow-hidden">
        <DrawerHeader>
