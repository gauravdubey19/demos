    ...
    return (
        <div className="space-y-4 animate-slide-up">
            ...
            >
                Category types
                <FaChevronDown
                    className={`transition-transform duration-300 ${isAccordionOpen === "category" ? "transform -rotate-180" : ""
                        }`}
                />
            </h3>
            <div
                className={`transition-max-height duration-300 ease-in-out overflow-hidden ${isAccordionOpen === "category" ? "max-h-screen" : "max-h-0"
                    }`}
            >
    ...
    return (
        <div className="space-y-4 animate-slide-up">
            ...
            >
                Colors
                <FaChevronDown
                    className={`transition-transform duration-300 ${isAccordionOpen === "color" ? "transform -rotate-180" : ""
                        }`}
                />
            </h3>
            <div
                className={`transition-max-height duration-300 ease-in-out overflow-hidden ${isAccordionOpen === "color" ? "max-h-screen" : "max-h-0"
                    }`}
            >
                <div className="flex flex-wrap gap-2 p-0.5">
                    {colorOptions.map(({ _id, title, color }) => (
                        <button
                            ...
                            className={`w-8 h-8 rounded-full border border-gray-200 ${selectedColor === title
    ...
    return (
        <div className="space-y-4 animate-slide-up">
            ...
            >
                Sizes
                <FaChevronDown
                    className={`transition-transform duration-300 ${isAccordionOpen === "size" ? "transform -rotate-180" : ""
                        }`}
                />
            </h3>
            <div
                className={`transition-max-height duration-300 ease-in-out overflow-hidden ${isAccordionOpen === "size" ? "max-h-screen" : "max-h-0"
                    }`}
            >
                <div className="flex flex-wrap gap-2 p-0.5">
                    {availableSizes.map((size, index) => (
                        <div key={index} className="">
                            <button
                                ...
                                className={`w-10 h-10 rounded-full flex-center border border-gray-200 text-sm ${selectedSize === size
                                        ? "border border-primary shadow-lg scale-110 opacity-100"
