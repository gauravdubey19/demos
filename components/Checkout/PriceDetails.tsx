...
const PriceDetails = ({ onProceed, cartData, currentStep, selectedItems }: PriceDetailsI) => {
    ...
    return (
        // <div className="md:w-[25%] w-full h-max border border-[#8888] rounded-lg text-[#888888] py-5 sticky top-20">
        ...
        //             <p>Total MRP</p>
        //             <p className="text-black">{"₹ "}{totalMRP}</p>
        //         </div>
        //         <div className="flex items-center justify-between px-5 text-lg">
        //             <p>Total Discount</p>
        //             <p className="text-[#2ed396]">{"- ₹ "}{totalDiscount}</p>
        //         </div>
        //         <div className="flex items-center justify-between px-5 text-lg">
        //             <p>Platform Fee</p>
        ...
        //         </div>
        //         <Button onClick={onProceed} className={`w-full text-xl hover:bg-[#d09631] flex items-center justify-center ${(currentStep === 'payment') ? "hidden" : "block"} `}>
        //            Proceed
        //         </Button>
        //     </div>
        // </div>
