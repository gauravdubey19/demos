...
const GridCards = () => {
      ...
      gsap.fromTo(
        ...
        { opacity: 0, y: 0 ,scale:.8}, 
        {
          ...
          scrollTrigger: {
            ...
            start: "top 80%", // Trigger the animation when the top of the container hits 80% of the viewport height
  ...
  return (
    <div className="sm:h-screen w-full overflow-hidden" ref={containerRef}>
