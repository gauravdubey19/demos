  ...
  return (
    <div className='md:h-screen w-full'>
      <div className='flex flex-col md:flex-row items-start justify-between md:px-20 sm:px-5 px-1 w-full gap-2 sm:gap-4 h-[75%]'>
        ...
        <div className='flex md:flex-col flex-row sm:gap-4 gap-2 md:w-[30%] w-full h-full'>
          <div className='h-[50%] w-full bg-[#F4F4F4] rounded-3xl  flex items-center justify-center'>
            <Image src={outfits[currentOutfit][0]} alt="image" width={100} height={100} className="w-full h-auto md:p-[6rem] xl:p-[8rem] p-8 object-contain" />
          </div>
          <div className='h-[50%] w-full bg-[#F4F4F4] rounded-3xl flex items-center justify-center'>
            <Image src={outfits[currentOutfit][1]} alt="image" width={100} height={100} className="w-full h-auto md:p-[6rem] xl:p-[8rem] p-8 object-contain" />
          </div>
        </div>
        ...
        <div className='flex md:flex-col flex-row sm:gap-4 gap-2 md:w-[30%] w-full md:h-full'>
          <div className='h-[50%] w-full bg-[#F4F4F4] rounded-3xl flex items-center justify-center'>
            <Image src={outfits[currentOutfit][3]} alt="image" width={100} height={100} className="w-full h-auto md:p-[6rem] xl:p-[8rem] p-8 object-contain" />
          </div>
          <div className='h-[50%] w-full bg-[#F4F4F4] rounded-3xl flex items-center justify-center'>
            <Image src={outfits[currentOutfit][4]} alt="image" width={100} height={100} className="w-full h-auto md:p-[6rem] xl:p-[8rem] p-8 object-contain" />
          </div>
        </div>
      </div>
