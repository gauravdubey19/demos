...
const ToastProvider = ({
  swipeDirection = "left",
  ...props
}: { swipeDirection?: "left" | "right" } & React.ComponentPropsWithoutRef<
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed top-[60px] z-[100] sm:bottom-0 sm:left-0 sm:top-auto w-full md:max-w-[420px] max-h-screen flex flex-col-reverse sm:flex-col p-4",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-2 top-2 rounded-md p-1 text-foreground/50 hover:text-foreground opacity-100 hover:opacity-100 focus:opacity-100 transition-opacity focus:outline-none focus:ring-2 group-[.destructive]:text-red-300 group-[.destructive]:hover:text-red-50 group-[.destructive]:focus:ring-red-400 group-[.destructive]:focus:ring-offset-red-600",
      className
    )}
    toast-close=""
    {...props}
